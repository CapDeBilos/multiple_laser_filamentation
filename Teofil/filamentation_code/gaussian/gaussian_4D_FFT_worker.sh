...
pin=${1:?Usage: ./gaussian_4D_FFT_worker.sh PIN_FACTOR}
...
echo "Running Gaussian 4D FFT artificial-plasma simulation at Pin/Pcr=$pin"
python gaussian_4D_FFT_artificial_plasma_simulation.py "$pin" "$pin" --step 0.5
echo "Finished Gaussian Pin/Pcr=$pin"
