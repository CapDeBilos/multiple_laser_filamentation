...
Run example:
    python gaussian_4D_FFT_artificial_plasma_simulation.py 1.1 2.0
"""
...
def run_one_pin(pin_factor, outdir):
    ...
    npz_path = os.path.join(outdir, f"Pin_{tag}_Pcr_gaussian_4D_FFT_diagnostics.npz")
    png_path = os.path.join(outdir, f"Pin_{tag}_Pcr_gaussian_4D_FFT_diagnostics.png")
    ...
    plt.grid(True)
    plt.legend()
    plt.title(f"Gaussian beam, Pin/Pcr = {pin_factor:.1f}")
    plt.tight_layout()
