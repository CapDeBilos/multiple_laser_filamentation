...
pin=${1:?Usage: ./Hermite_4D_FFT_worker.sh PIN_FACTOR}
...
echo "Running Hermite 4D FFT artificial-plasma simulation at Pin/Pcr=$pin"
python Hermite_4D_FFT_artificial_plasma_simulation.py "$pin" "$pin" --step 0.5
echo "Finished Hermite Pin/Pcr=$pin"
