...
Run example:
    python THOMAS_PCR_adaptive_FFT_sweep_xy_no_t_memory_optimized.py 1.1 2.0
"""
...
def run_one_pin(pin_factor, outdir):
    ...
    npz_path = os.path.join(outdir, f"Pin_{tag}_Pcr_xy_no_t_memory_optimized.npz")
    png_path = os.path.join(outdir, f"Pin_{tag}_Pcr_xy_no_t_memory_optimized.png")
...
def main():
    ...
    outdir = f"pin_sweep_xy_no_t_memory_optimized_{sweep}"
