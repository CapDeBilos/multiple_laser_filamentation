...
def run_one_pin(pin_factor, outdir):
    ...
    E = cp.zeros((Nx, Nt), dtype=cp.complex128)
    number_1 = int(0.45 * Nx); number_2 = int(0.55 * Nx); square_side_length = (number_2 - number_1) * DeltaX
    number_3 = int(0.45 * Nt); number_4 = int(0.55 * Nt)
    amp = cp.sqrt(Pin / square_side_length**2)
